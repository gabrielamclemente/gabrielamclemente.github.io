...
export const translations = {
  en: {
    ...
    about: {
      ...
      lede: "I'm a software developer with a neuroscience research background — a double major in Computer Science and Neuroscience, an honors thesis in glial signaling, and a habit of reaching for code whenever the data gets bigger than a spreadsheet. Research, engineering, and a camera: the three strands in the tagline are the three things I actually do. (placeholder — rewrite in your own voice)",
    },
  ...
  pt: {
    ...
    about: {
      ...
      lede: "Sou desenvolvedora de software com formação em pesquisa em neurociência — dupla graduação em Ciência da Computação e Neurociência, uma tese de honras em sinalização glial e o hábito de recorrer ao código sempre que os dados ficam maiores que uma planilha. Pesquisa, engenharia e uma câmera: os três fios do subtítulo são as três coisas que eu de fato faço. (placeholder — reescreva com a sua voz)",
    },
  ...
  es: {
    ...
    about: {
      ...
      lede: "Soy desarrolladora de software con formación en investigación en neurociencia — doble titulación en Ciencia de la Computación y Neurociencia, una tesis de honores en señalización glial y la costumbre de recurrir al código cuando los datos superan una hoja de cálculo. Investigación, ingeniería y una cámara: los tres hilos del subtítulo son las tres cosas que de verdad hago. (placeholder — reescríbelo con tu voz)",
    },
